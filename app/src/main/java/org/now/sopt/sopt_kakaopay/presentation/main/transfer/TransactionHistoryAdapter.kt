...
class TransactionHistoryAdapter(private val bookmarkClickListener: (TransactionHistoryDto) -> Unit) :
    ListAdapter<TransactionHistoryDto, TransactionHistoryViewHolder>(
        ItemDiffCallback(onItemsTheSame = { oldItem, newItem -> oldItem.bankAccount == newItem.bankAccount },
    ...
    override fun onCreateViewHolder(
        ...
        return TransactionHistoryViewHolder(binding, bookmarkClickListener)
    }
